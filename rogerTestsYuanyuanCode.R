if(getNamespaceVersion(ns="CTDesignExplorer") != "1.0")
  warning("version of CTDesignExplorer should be 1.0;  it is ", 
          getNamespaceVersion(ns="CTDesignExplorer"))    
library("CTDesignExplorer")

# createCTDesignCatalog = function() {
